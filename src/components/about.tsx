...
const About = () => {
  return (
    <section className="pb-20 2xl:px-20">
      <h2 className="text-2xl font-extrabold font-['paralucent'] before:content-['01.'] before:font-mono before:mr-2 text-gray-300 before:text-sun-500 before:text-xl text-sun before:bottom-2">
        About Me
      </h2>
      <p className="my-6 leading-relaxed text-md text-midnight-400">
