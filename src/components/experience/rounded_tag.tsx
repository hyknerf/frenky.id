...
const RoundedTags = (tags: TagsProp) => {
  const renderedTags = tags.texts.map((item) => {
    return (
      <li key={item} className="group px-2 py-[2px] border-[1px] border-sun-500 text-white rounded-[3px] hover:bg-sun-500 hover:px-3 transition-all hover:cursor-default">
